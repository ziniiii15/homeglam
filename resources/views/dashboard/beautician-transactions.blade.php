...
<title>Beautician Transactions - HomeGlam</title>
...
<div class="page-wrapper">
    <div class="page-header">
        <div>
            ...
            <p class="text-muted mb-0">All payments recorded for your bookings.</p>
        </div>
        <a href="{{ route('beautician.dashboard') }}" class="btn btn-outline-secondary btn-sm rounded-pill">
        ...
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    ...
                    <small class="text-muted">Includes completed and verified payments.</small>
                </div>
            </div>
        </div>
